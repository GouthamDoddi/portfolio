...
const renderContent = {
    ...
    >Hi I am <span className='font-semibold'>Goutham</span>👋
    <br></br>
    A Software Engineer from India</h1>),
    2: (<InfoBox text="Worked with many companies and picked up many skills along the way." 
        link="/about"
        btnText="Learn more"/>),
    3: (<InfoBox text="Created multiple projects along the way." 
    link="/projects"
